    ...
    <div class="layui-row">
        <div class="layui-col-md12">
            <fieldset class="layui-elem-field layui-field-title">
                <legend id="weekReportDetailTitle">添加会员</legend>
            </fieldset>
        ...
        $.ajax({
            ...
            ,success: function (data) {
                ...
                for(var i = 0; i < data.data.length; i++){
                    level += '<option value="'+data.data[i].id+'">'+data.data[i].levelName+'</option>';
                }
                $('#level').append(level);
            }
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    layer.msg(data.msg,
                            ...
                            ,function(){
                                $.ajax({
                                    type: 'POST',
                                    url: '/person/printPersonCard', // 打印会员票据
                                    data: $('#personForm').serialize(),
                                    dataType: 'json',
                                    success: function (data) {
                                        layer.msg(data.msg,
                                                ...
                                                ,function(){
                                                    window.location.href = '/page/person_manage';
                                                });
                                    },
                                    error: function (data) {
                                        layer.msg(data.msg,
                ...
                error: function (data) {
                    layer.msg(data.msg,
                            ...
                            ,function(){
                                window.location.href = '/page/add_person';
                            });
                }
            });
        });
